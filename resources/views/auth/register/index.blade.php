        ...
        <div class="col-lg-5">
            <form action="/register" method="post">
                ...
                <div class="nip mb-3">
                    ...
                    <input type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" id="nip" placeholder="NIP anda" autocomplete="off" required>
                    @error('nip')
                ...
                <div class="nama mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_guru') is-invalid @enderror" name="nama_guru" id="nama_guru" placeholder="Nama anda" autocomplete="off" required>
                    @error('nama_guru')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
